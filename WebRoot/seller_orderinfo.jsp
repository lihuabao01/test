						...
						<s:form action="#" method="post" name="theForm" id="theForm"
							...
							<table width="100%" align="center">
								...
								<s:iterator value="oinfolist" status="status">
									<tr>
										<td><img src="upload/<s:property value="oinfoPic"/>"
											Style="width:80px;height:80px;" /></td>
										<td><s:property value="oinfoName" /></td>
										<td><s:property value="oinfoType" /></td>
										<td>￥<s:property value="oinfoPrice" /></td>
										<td><s:property value="oinfoNum" /></td>
										<td>￥<s:property value="oinfoSub" /></td>
									</tr>
								</s:iterator>
							</table>
							<table width="100%" align="center" border="0" cellpadding="5"
								...
								<tr>
									<td class="align_left"><p Style="margin-left: 20px">
											购物金额总额￥
											<s:property value="order.orderSub" />
										</p>
									</td>
